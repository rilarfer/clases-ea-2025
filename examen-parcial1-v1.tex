...
%==================== CABECERA ====================
\begin{center}
    \textit{\textbf{Estadística Aplicada — Examen Parcial (Versión A)}}\\
...
Un grupo de \textbf{20 estudiantes universitarios} registró cuántas horas durmieron en una noche normal de semana. Los datos (en horas) son los siguientes:\[
5.8,\ 6.3,\ 7.2,\ 8.1,\ 6.5,\ 7.7,\ 7.1,\ 6.0,\ 5.5,\ 8.0,\ 7.4,\ 6.9,\ 7.6,\ 6.4,\ 7.0,\ 8.3,\ 5.9,\ 6.7,\ 7.3,\ 7.9
\]
...
\[
\text{Grupo A: } 4.2,\ 4.6,\ 4.8,\ 5.0,\ 5.4,\ 5.6,\ 5.8,\ 6.2
\]
\[
\text{Grupo B: } 3.8,\ 4.0,\ 4.4,\ 4.7,\ 5.0,\ 5.3,\ 5.7,\ 6.2
\]
...
\[
P(S)=0.05 \quad (\text{correos realmente spam}), \qquad P(S')=0.95 \quad (\text{correos legítimos})
\]
El filtro de spam tiene las siguientes características:
\[
P(\text{Marcado}\mid S)=0.96, \qquad P(\text{Marcado}\mid S')=0.01.
\]
