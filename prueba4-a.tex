...
%==================== CABECERA ====================
\begin{center}
    \textit{\textbf{Investigación de Operaciones I — Prueba en Parejas (Versión A)}}\\
...
%==================== INICIO PREGUNTA ====================
\begin{questions}
\question[10] \textbf{Problema de transporte balanceado (Versión A).}
...
\begin{parts}
  ...
  \vspace{1.4cm}
  \part[1] Compare las tres soluciones: ¿son \textbf{distintas} las SBFI? Justifique brevemente.
  \vspace{0.8cm}
\end{parts}
