...
\begin{frame}{Ejemplo: promedio de graduados UNI (solución)}
  ...
  \[
    68.581 \le \mu \le 78.019.
  \]

  \begin{center}
    \small El promedio de notas se encuentra entre 68.581 y 78.019
...
\begin{frame}{Ejemplo: Sistemas vs Computación (solución)}
  ...
  \begin{center}
    \small La diferencia real no puede ser $0$, por lo que
     hay evidencia de diferencia significativa al 95\%.
  \end{center}
\end{frame}
...
\begin{frame}{Ejemplo: máquinas (solución)}
  \[
    s_p^2 =
    \frac{(15-1)2.5^2 + (15-1)3^2}{15+15-2}
    = 7.625,\quad s_p \approx 2.761.
  \]

  \[
    \alpha = 0.01,\quad
    t_{(1-\alpha/2),\,n_1+n_2-2}
    = t_{0.995,\,28} \approx 2.76326.
  \]

  IC:
  \[
    (\bar x_1 - \bar x_2) \pm
    2.76326\cdot 2.761\sqrt{\frac{1}{15}+\frac{1}{15}}.
  \]

  \[
    45-36 - 2.76326(2.761)\sqrt{\tfrac{1}{15}+\tfrac{1}{15}}
    \le \mu_1 - \mu_2 \le
    45-36 + 2.76326(2.761)\sqrt{\tfrac{1}{15}+\tfrac{1}{15}}.
  \]

  \[
    6.2138 \le \mu_1 - \mu_2 \le 11.7862.
  \]

  \begin{center}
    \small La máquina 1 deja de trabajar entre 6.2138 y 11.7862 minutos más
